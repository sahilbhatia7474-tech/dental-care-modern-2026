...
export const TrustStats: React.FC = () => {
  return (
    <section className="border-y border-white/10 bg-white/[0.02] backdrop-blur-md relative z-10">
      <div className="mx-auto grid max-w-7xl grid-cols-2 px-5 py-8 sm:px-8 md:grid-cols-4 gap-y-6">
        
        {/* Stat 1 */}
        <div className="border-white/10 px-5 py-2 text-center md:border-r flex flex-col items-center justify-center">
        ...
        <div className="border-white/10 px-5 py-2 text-center md:border-r flex flex-col items-center justify-center">
          <div className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight flex items-center justify-center gap-1.5">
            ...
            <Star className="w-5 h-5 text-orange-400 fill-orange-400 inline" />
          </div>
        ...
        {/* Stat 4 */}
        <div className="px-5 py-2 text-center flex flex-col items-center justify-center">
