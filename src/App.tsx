...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0E0A14] text-white selection:bg-orange-400/30 pb-20 md:pb-0">
      {/* Header Navigation */}
      <Header
      ...
      <main>
        ...
        <ContactFooter onOpenVoiceAi={handleOpenVoiceAi} />
      </main>

      {/* Floating AI Assistant Trigger Button (Desktop & Tablet) */}
      <div className="hidden md:flex fixed bottom-6 right-6 z-40 flex-col items-end gap-2">
        ...
        <button
          ...
          className="group relative flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full orange-gradient text-xl sm:text-2xl text-[#1B0D05] shadow-[0_10px_40px_rgba(255,138,61,.35)] transition-all duration-300 hover:scale-110 active:scale-95"
        >
